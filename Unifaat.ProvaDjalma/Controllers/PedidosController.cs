...
namespace Unifaat.ProvaDjalma.Controllers
{
    public class PedidosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PedidoId,ClienteId")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PedidoId,ClienteId")] Pedido pedido)
        {
