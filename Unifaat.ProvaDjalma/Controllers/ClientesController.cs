...
namespace Unifaat.ProvaDjalma.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,NomeCompleto,Telefone,Email,CPF,CNPJ,VendedorId")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,NomeCompleto,Telefone,Email,CPF,CNPJ,VendedorId")] Cliente cliente)
        {
